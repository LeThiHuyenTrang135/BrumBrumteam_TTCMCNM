                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                            ...
                            <div class="position-relative row form-group">
                                <label for="content" class="col-md-3 text-md-right col-form-label">Nội dung chi
                                    tiết</label>
                                <div class="col-md-9 col-xl-8">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input type="file"
                                        ...
                                        name="images[]" multiple accept="image/*" onchange="previewImages(event)">
                            ...
                            <div class="position-relative row form-group">
                                <label for="featured" class="col-md-3 text-md-right col-form-label">Sản phẩm nổi
                                    bật</label>
                                <div class="col-md-9 col-xl-8">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="featured">Đánh dấu là sản phẩm nổi
                                            bật</label>
                                    </div>
                                </div>
                            </div>
